!
    ...
    function(e, t) {
        ...
        var i = '<div class="mui-poppicker">   <div class="mui-poppicker-header">			<span class="mui-btn mui-poppicker-btn-cancel">取消</span>		<span id="datepickertitle" class="datepickertitle"></span>  	<span class="mui-btn mui-btn-blue mui-poppicker-btn-ok">确定</span>			<div class="mui-poppicker-clear"></div>		</div>	<div class="mui-line"></div>		<div class="mui-poppicker-body">		</div>	</div>',
        ...
        e.PopPicker = e.Class.extend({
            init: function(n) {
                ...
                a.options = n || {},
                    ...
                    a.datepickertitle = a.panel.querySelector(".datepickertitle"),
                    a.datepickertitle.innerText = "tesst",
                    a.mask = e.createMask(),
    ...
    function(e, t) {
        ...
        var i = '<div class="mui-dtpicker" data-type="datetime">	<div class="mui-dtpicker-header clearfix">		<span data-id="btn-cancel" class="mui-btn mui-btn-left">取消</span>	 <span data-id="titletext" class="mui-title-text"></span>	<span data-id="btn-ok" class="mui-btn mui-btn-right">确定</span>		</div>	<div class="mui-line"></div>		<div class="mui-dtpicker-title"><h5 data-id="title-y">年</h5><h5 data-id="title-m">月</h5><h5 data-id="title-d">日</h5><h5 data-id="title-h">时</h5><h5 data-id="title-i">分</h5></div>		<div class="mui-dtpicker-body">			<div data-id="picker-y" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-m" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-d" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-h" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>			<div data-id="picker-i" class="mui-picker">				<div class="mui-picker-inner">					<div class="mui-pciker-rule mui-pciker-rule-ft"></div>					<ul class="mui-pciker-list">					</ul>					<div class="mui-pciker-rule mui-pciker-rule-bg"></div>				</div>			</div>		</div>	</div>';
        e.DtPicker = e.Class.extend({
            init: function(n) {
                ...
                var s = a.ui = {
                    ...
                    titletext:e('[data-id="titletext"]',r)[0]
                };
            ...
            getDayNum: function(e, t) {
                var i = this;
                return i._6([1, 3, 5, 7, 8, 10, 12], t) ? 31 : i._6([4, 6, 9, 11], t) ? 30 : i.isLeapYear(e) ? 29 : 28
            },
            _0: function(e) {
                return e = e.toString(),
                e.length < 2 && (e = 0 + e),
            ...
            _11: function(e) {
                ...
                if(i.customData.m) a = i.customData.m;
                    ...
                    for(var r = i.beginMonth && t._7() ? i.beginMonth : 1, s = i.endMonth && t._8() ? i.endMonth : 12; s >= r; r++) {
                        var c = t._0(r);
                        a.push({
                            text: c+ "月",
                            value: c
            ...
            _1: function(e) {
                ...
                if(i.customData.d) a = i.customData.d;
                    ...
                    for(var r = t._5() ? i.beginDay : 1, s = t._2() ? i.endDay : t.getDayNum(parseInt(this.ui.y.picker.getSelectedValue()), parseInt(this.ui.m.picker.getSelectedValue())); s >= r; r++) {
                        var c = t._0(r);
                        a.push({
                            text: c+ "日",
                            value: c
            ...
            _10: function(e) {
                ...
                if(i.customData.h) a = i.customData.h;
                    ...
                    for(var r = t._3() ? i.beginHours : 0, s = t._4() ? i.endHours : 23; s >= r; r++) {
                        var c = t._0(r);
                        a.push({
                            text: c,
                            value: c
            ...
            _9: function(e) {
                ...
                if(i.customData.i) a = i.customData.i;
                    ...
                    for(var r = t._15() ? i.beginMinutes : 0, s = t._16() ? i.endMinutes : 59; s >= r; r++) {
                        var c = t._0(r);
                        a.push({
                            text: c,
                            value: c
            ...
            show: function(titletext,i) {
                var n = this,
                    a = n.ui;
//				debugger
                a.titletext.innerText=titletext;
                n.callback = i || e.noop,
                    a.mask.show(),
